...
// Lista base de colores permitidos para etiquetas de tarea
...
// Devuelve clases visuales segun el color de una etiqueta
export function taskLabelColorClasses(color: TaskLabelColor): string {
  // Mapea color logico a clases tailwind para chips de etiqueta
  switch (color) {
    case 'green':
...
// Devuelve el color de barra para graficos de etiquetas
export function taskLabelChartBarFill(color: TaskLabelColor): string {
  // Mapea color logico a tono usado en barras del grafico
  switch (color) {
    case 'green':
      return 'oklch(0.78 0.11 160)';
    case 'yellow':
      return 'oklch(0.88 0.12 95)';
    case 'orange':
      return 'oklch(0.8 0.13 55)';
    case 'red':
      return 'oklch(0.76 0.12 18)';
    case 'purple':
      return 'oklch(0.74 0.13 300)';
    case 'sky':
      return 'oklch(0.8 0.1 230)';
    case 'gray':
      return 'oklch(0.78 0.02 260)';
    case 'blue':
    default:
      return 'oklch(0.74 0.12 264)';
  }
}
