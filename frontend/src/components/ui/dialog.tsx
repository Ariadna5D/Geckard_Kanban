...
function Dialog({
  ...
  // Root maneja estado abierto cerrado del dialogo
...
function DialogOverlay({
  ...
  // Overlay tapa fondo para evitar interaccion accidental
  return (
    <DialogPrimitive.Overlay
      data-slot="dialog-overlay"
      className={classNames(DIALOG_OVERLAY_CLASS, className)}
      {...props}
    />
  )
}
...
function DialogContent({
  ...
  return (
    <DialogPortal>
      <DialogOverlay />
      {/* Content renderiza cuerpo principal del modal */}
      <DialogPrimitive.Content
        data-slot="dialog-content"
        className={classNames(DIALOG_CONTENT_CLASS, className)}
        {...props}
      >
        {children}
        {showCloseButton && (
