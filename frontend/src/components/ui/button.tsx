  ...
  "group/button inline-flex shrink-0 items-center justify-center rounded-lg border border-transparent bg-clip-padding text-base font-medium whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        outline:
          "border-border bg-background hover:border-primary-500/35 hover:bg-primary-500/10 hover:text-foreground aria-expanded:bg-muted aria-expanded:text-foreground dark:border-input dark:bg-input/30 dark:hover:border-primary-400/40 dark:hover:bg-primary-500/10",
        secondary:
          "bg-secondary text-secondary-foreground hover:bg-secondary/80 aria-expanded:bg-secondary aria-expanded:text-secondary-foreground",
        ghost:
          "hover:bg-primary-500/10 hover:text-foreground aria-expanded:bg-muted aria-expanded:text-foreground dark:hover:bg-primary-500/15 dark:hover:bg-muted/50",
        destructive:
      ...
      size: {
        ...
        "icon-lg": "size-9",
        /** Icono cuadrado alineado con fila de acciones del tablero (Filtro, Ordenar, Invitar…) */
        "icon-row":
          "h-11 w-11 shrink-0 gap-0 rounded-lg p-0 [&_svg:not([class*='size-'])]:size-[1.25rem]",
      },
    },
    defaultVariants: {
      variant: "default",
