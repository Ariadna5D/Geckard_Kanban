...
function Sheet({ ...props }: React.ComponentProps<typeof SheetPrimitive.Root>) {
  // Root maneja estado abierto cerrado del panel lateral
...
function SheetOverlay({
  ...
  return (
    <SheetPrimitive.Overlay
      ...
      className={classNames(SHEET_OVERLAY_CLASS, className)}
      {...props}
    />
  )
}
...
function SheetContent({
  ...
  return (
    <SheetPortal>
      <SheetOverlay />
      {/* Content usa side para entrar desde derecha izquierda arriba o abajo */}
      <SheetPrimitive.Content
        data-slot="sheet-content"
        data-side={side}
        className={classNames(SHEET_CONTENT_CLASS, className)}
        {...props}
      >
        {children}
        {showCloseButton && (
