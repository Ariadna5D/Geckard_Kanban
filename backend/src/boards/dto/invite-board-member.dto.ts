...
const INVITE_ROLES = [BoardRole.ADMIN, BoardRole.EDITOR, BoardRole.VIEWER] as const;
...
export class InviteBoardMemberDto {
  ...
  @ApiProperty({ enum: INVITE_ROLES, description: 'Rol en el tablero (no se asigna owner por aquí)' })
  @IsIn([...INVITE_ROLES], {
